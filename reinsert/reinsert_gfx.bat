...
..\tools\patch track2.bin 0x21DA94 0x68 0x69 0x78 0x79
..\tools\patch track2.bin 0x21DA98 0x6C 0x6D 0x7C 0x7D
:: Alter the map of metatiles (foe second-last screen with TOPICS and DENTSU):
..\tools\patch track2.bin 0x21DE1A 0xA0 0xA1 0xA2 0xA3 0xA4 0xA5
::
