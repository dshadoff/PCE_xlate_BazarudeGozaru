...
..\tools\pce_gfx get sprite track2.bin 0x0164000 2 2 2 162800.orig 96 0 ..\xlate\162800.xlate
...
..\tools\pce_gfx get tile track2.bin 0x01AA400 16 16 2 1AA400.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01AFC00 16 16 2 1AFC00.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01B5400 16 16 2 1B5400.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01BAC00 16 16 2 1BAC00.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01C0400 16 16 2 1C0400.orig 0 0 ..\xlate\1A1400.xlate
...
..\tools\pce_gfx get tile track2.bin 0x01AC100 16 8 2 1AC100.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01B1900 16 8 2 1B1900.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01B7100 16 8 2 1B7100.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01BC900 16 8 2 1BC900.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01C2100 16 8 2 1C2100.orig 0 0 ..\xlate\1A1400.xlate
...
..\tools\pce_gfx get tile track2.bin 0x01B7500 16 8 2 1B7500.orig 0 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01B7D00 2 2 1 1B7500.orig 64 0 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01B73E0 1 1 1 1B7500.orig 64 8 ..\xlate\1A1400.xlate
..\tools\pce_gfx get tile track2.bin 0x01BCD00 16 8 2 1BCD00.orig 0 0 ..\xlate\1A1400.xlate
...
..\tools\pce_gfx get sprite track2.bin 0x0168000 2 2 2 166800.orig 96 0 ..\xlate\166800.xlate
...
..\tools\pce_gfx get tile track2.bin 0x01E54C0 16 2 2 1E54C0.orig 0 0 ..\xlate\17C000.xlate
..\tools\pce_gfx get tile track2.bin 0x01E84C0 16 2 2 1E84C0.orig 0 0 ..\xlate\17C000.xlate
...
..\tools\pce_gfx get tile track2.bin 0x00BB800 16 16 2 0BB800.orig 0 0 ..\xlate\0BB800.xlate

:: "Start" and "Select"
..\tools\pce_gfx get tile track2.bin 0x00BCC00 16 12 1 0BCC00.orig 0 0 ..\xlate\0BCC00.xlate
..\tools\pce_gfx get tile track2.bin 0x00BD000 16 12 1 0BD000.orig 0 0 ..\xlate\0BCC00.xlate
...
::Note: 0C0000 and 187000 are the same - "Omoide"
..\tools\pce_gfx get tile track2.bin 0x00C0000 16 5 2 0C0000.orig 0 0 ..\xlate\0C0000.xlate
..\tools\pce_gfx get tile track2.bin 0x0187000 16 5 2 187000.orig 0 0 ..\xlate\0C0000.xlate

::Note: 0C1800 amd 188000 are the same except for translation key
::      "Erande kudasai"
...
::
::Note: These are all ** GOAL ** signs with slight variations
::
..\tools\pce_gfx get tile track2.bin 0x00DA000 16 4 4 0DA000.orig 0 0 ..\xlate\0DA000.xlate
..\tools\pce_gfx get tile track2.bin 0x00DF800 16 4 4 0DF800.orig 0 0 ..\xlate\0DF800.xlate
..\tools\pce_gfx get tile track2.bin 0x00ED100 16 4 4 0ED100.orig 0 0 ..\xlate\0DF800.xlate
..\tools\pce_gfx get tile track2.bin 0x00FCC80 16 4 4 0FCC80.orig 0 0 ..\xlate\0FCC00.xlate
..\tools\pce_gfx get tile track2.bin 0x0220900 16 4 4 220900.orig 0 0 ..\xlate\0DA000.xlate
...
..\tools\pce_gfx get sprite track2.bin 0x00A0E00 2 2 2 0A0E00.orig 0 0 ..\xlate\0A0C00.xlate
..\tools\pce_gfx get sprite track2.bin 0x00A1000 2 2 2 0A1000.orig 0 0 ..\xlate\0A0C00.xlate
..\tools\pce_gfx get sprite track2.bin 0x00A1200 2 2 2 0A1200.orig 0 0 ..\xlate\0A0C00.xlate
..\tools\pce_gfx get sprite track2.bin 0x00A1400 2 2 2 0A1400.orig 0 0 ..\xlate\0A0C00.xlate
..\tools\pce_gfx get sprite track2.bin 0x00A1600 2 2 2 0A1600.orig 0 0 ..\xlate\0A0C00.xlate
...
..\tools\pce_gfx get sprite track2.bin 0x0157800 2 2 2 157800.orig 0 0 ..\xlate\117000.xlate
..\tools\pce_gfx get sprite track2.bin 0x0158000 2 2 2 157800.orig 32 0 ..\xlate\117000.xlate
